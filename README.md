...
Pset 5 was not technically designed as a library, but if it has a `setup.py`,
you may pipenv install it the same way you do w/ `csci_utils`! Otherwise, you
may refactor into `csci_utils` or copy/paste code as necessary.
...
* You should probably use dask for calculating the aggregations
